  ...
  "/open-checklist-popup": [
    {
      ...
      desc: [
        {
          title: "선행 개발 필요사항",
          body: "PG 또는 내부 시스템으로부터 PG 심사 상태값(2/3/4/5)을 조회할 수 있는 기능이 먼저 개발되어야 합니다. PG사 API 연동을 통해 실시간으로 받아올지, 내부 신청 테이블에서 상태 컬럼을 두고 운영자가 수동으로 갱신하는 방식으로 갈지 협의가 필요합니다.",
        },
        {
          title: "완료 조건",
          body: "상태값이 \"2\"(신청접수) 이상인 경우, 체크리스트 항목을 완료 처리합니다. 판매자의 \"신청하기\" 버튼 클릭 자체는 완료의 조건이 아니며 실제 상태값 확인을 거쳐야 합니다.",
        },
        {
          title: "상태 표시",
          body: "체크리스트 항목 옆 배지와 상세화면 타이틀 영역에 조회된 상태값(2/3/4/5)을 그대로 노출합니다. 상태값이 확인되지 않은 경우(선행 기능 미개발 또는 조회 실패 시) \"확인중\"으로 표시하고 추정값을 임의로 보여주지 않습니다.",
        },
        {
          title: "범례",
